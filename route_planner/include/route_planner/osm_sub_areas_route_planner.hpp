...
private:  
  bool request_nodes_and_tags(std::vector<ropod_ros_msgs::SubArea>::iterator wayp_areas_it, std::vector<std::vector<ropod_ros_msgs::Area>::iterator>::iterator sub_areas_areait,std::vector<ropod_ros_msgs::Position>& area_nodes, std::string&  area_type);
